...
interface BeamPath {
  path: string;
  gradientConfig: BeamGradientConfig;
...
const BeamsSvg = ({ beams, width, height, baseColor, accentColor, gradientColors }: BeamsSvgProps) => {
  return (
    <svg
      width={width}
      height={height}
...
const GradientStops = ({ colors = DEFAULT_GRADIENT_COLORS }: { colors?: GradientColors }) => {
  return (
    <>
