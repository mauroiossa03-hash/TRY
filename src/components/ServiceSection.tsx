import { Send, LineChart, ShieldCheck, ArrowRight } from "lucide-react";
...
export default function ServiceSection() {
  const { recentSignals } = usePerformanceContext();
  ...
  return (
    <section id="service" aria-labelledby="service-heading" className="relative py-24 sm:py-32 bg-bg-soft border-t border-border">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <ScrollReveal delay={0.25} className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <a
            href={TELEGRAM_URL}
            target="_blank"
